...
async function updateProfileOnServer(payload: any): Promise<any> {
    // Primary (referral-user)
    try {
        return await apiFetch<any>("/referral-user/profile", {
            method: "PATCH",
...
const ReferralUserSettings: React.FC = () => {
    ...
    const handleSaveProfile = async (event: React.FormEvent) => {
        ...
        if (!isReferralRole) {
            toast.error("This page is only available for referral-user accounts.");
            return;
        }
    ...
    return (
        <DashboardLayout
            title="Settings"
            description="Manage your referral-user account details, password, and profile picture."
        >
                ...
                <div className="w-full max-w-3xl space-y-6">
                    ...
                    <Card className="border-indigo-100/80 bg-white/80 shadow-sm shadow-indigo-100/60 backdrop-blur">
                        <CardHeader>
                            ...
                            <CardDescription className="text-xs text-muted-foreground">
                                Upload a clear photo to help counselors recognize your account.
                            </CardDescription>
                        </CardHeader>
                    ...
                    <Card className="border-indigo-100/80 bg-white/80 shadow-sm shadow-indigo-100/60 backdrop-blur">
                        <CardHeader>
                            ...
                            <CardDescription className="text-xs text-muted-foreground">
                                Use a strong, unique password to protect your referral-user account.
                            </CardDescription>
                        </CardHeader>
...
export default ReferralUserSettings;

...
function notifyCountersRefresh() {
...
const StudentMessages: React.FC = () => {
    ...
    const isMineMessage = React.useCallback(
        (m: UiMessage) => {
                        ...
                        <div className="grid min-h-[640px] grid-cols-1 sm:min-h-[680px] md:grid-cols-[340px_1fr]">
                            ...
                            >
                                <div className="p-3 sm:p-4">
                                    ...
                                    {showNewMessage ? (
                                        <Card className="mt-3 border bg-white/60 shadow-none">
                                            <CardHeader className="p-3 pb-2">
                                                <CardTitle className="text-sm">New message</CardTitle>
                                                <CardDescription className="text-xs">
                                                    Search your counselor directory and create a new thread.
                                                </CardDescription>
                                            </CardHeader>
                                    ...
                                    <div className="space-y-2 p-3 sm:p-4">
                                        {isLoading ? (
                                            ...
                                            filteredConversations.map((c) => {
                                                ...
                                                const isUnreadThread = c.unreadCount > 0
                                                ...
                                                return (
                                                    <Button
                                                        ...
                                                        className={cn(
                                                            ...
                                                            isUnreadThread ? "ring-1 ring-amber-200" : "",
                                                        )}
                                                    >
                                                            ...
                                                            <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between sm:gap-3">
                                                                <div className="flex min-w-0 items-center gap-2 sm:gap-3">
                                                                    ...
                                                                    <div className="min-w-0">
                                                                        <div
                                                                            className={cn(
                                                                                "truncate text-[0.92rem] text-slate-900 sm:text-sm",
                                                                                isUnreadThread ? "font-bold" : "font-semibold",
                                                                            )}
                                                                        >
                                                                            {ui.name}
                                                                        </div>

...
async function updateProfileOnServer(payload: any): Promise<any> {
    // Primary (admin)
    try {
        return await apiFetch<any>("/admin/profile", {
            method: "PATCH",
...
const AdminSettings: React.FC = () => {
    ...
    const isAdminRole =
        ...
        roleNorm.includes("administrator") ||
    ...
    const handleSaveProfile = async (event: React.FormEvent) => {
        ...
        if (!isAdminRole) {
            toast.error("This page is only available for admin accounts.")
            return
        }
    ...
    return (
        <DashboardLayout
            title="Settings"
            description="Manage your admin account details, password, and profile picture."
        >
                ...
                <div className="w-full max-w-3xl space-y-6">
                    ...
                    <Card className="border-indigo-100/80 bg-white/80 shadow-sm shadow-indigo-100/60 backdrop-blur">
                        <CardHeader>
                            ...
                            <CardDescription className="text-xs text-muted-foreground">
                                Upload a clear photo for your admin account.
                            </CardDescription>
                        </CardHeader>
                    ...
                    <Card className="border-indigo-100/80 bg-white/80 shadow-sm shadow-indigo-100/60 backdrop-blur">
                        <CardHeader>
                            ...
                            <CardDescription className="text-xs text-muted-foreground">
                                Use a strong, unique password to protect your admin account.
                            </CardDescription>
                        </CardHeader>
